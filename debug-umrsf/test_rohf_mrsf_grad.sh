#!/bin/bash
#
# Test for ROHF Mixed-Reference Spin-Flip TDDFT gradient (pure HF)
...
# ============ CONFIG ============
INPUT="oqp-rohf-mrsf-grad.inp"
LOG="oqp-rohf-mrsf-grad.log"
...
# ============ MAIN ============
echo "============================================================"
echo "TEST: ROHF MRSF-TDDFT Gradient (C2F2H2, pure HF)"
echo "============================================================"
