#!/bin/bash
#
# Test for ROHF Spin-Flip TDDFT gradient (pure HF)
...
# ============ CONFIG ============
INPUT="oqp-rohf-sf-grad.inp"
LOG="oqp-rohf-sf-grad.log"

# Reference values (from GAMESS, pure HF)
REF_E1="-275.4908721870"   # SF state 1 (target)

# Reference gradient state 1 (from GAMESS)
#          X              Y              Z
REF_C1="-0.032351534   0.099224862  -0.502852463"
REF_C2="-0.029172292  -0.051314372  -0.420911816"
REF_F1=" 0.042492803  -0.273670056   0.425350976"
REF_F2=" 0.057219202   0.234773850   0.346462222"
REF_H1="-0.035541567  -0.069042593   0.076806498"
REF_H2="-0.002646613   0.060028309   0.075144583"
...
# ============ MAIN ============
echo "============================================================"
echo "TEST: ROHF Spin-Flip TDDFT Gradient (C2F2H2, pure HF)"
echo "============================================================"
