#!/bin/bash
#
# Test for ROKS Spin-Flip TDDFT gradient (BHHLYP functional)
...
# ============ CONFIG ============
INPUT="oqp-roks-sf-grad.inp"
LOG="oqp-roks-sf-grad.log"

# Reference values (from GAMESS, BHHLYP)
REF_E1="-276.6700392182"   # SF state 1 (target)

# Reference gradient state 1 (from GAMESS)
#          X              Y              Z
REF_C1="-0.045500869   0.129848973  -0.481434376"
REF_C2="-0.018890255  -0.086696771  -0.403039456"
REF_F1=" 0.047907442  -0.271318139   0.415829498"
REF_F2=" 0.050434551   0.227741279   0.338419120"
REF_H1="-0.030282094  -0.055774449   0.060865009"
REF_H2="-0.003668776   0.056199108   0.069360206"

# Tolerances (DFT needs slightly looser tolerance)
TOL_E="1e-5"
TOL_G="1e-4"
...
# ============ MAIN ============
echo "============================================================"
echo "TEST: ROKS Spin-Flip TDDFT Gradient (C2F2H2, BHHLYP)"
echo "============================================================"
