#!/bin/bash
#
# Test for ROHF Mixed-Reference Spin-Flip TDDFT gradient with GMRES solver
# Molecule: C2F2H2 (low symmetry)
# Compares: MRSF energies, gradients (same reference as CG solver)
#
...
# ============ CONFIG ============
INPUT="oqp-rohf-mrsf-grad-gmres.inp"
LOG="oqp-rohf-mrsf-grad-gmres.log"

# Reference values (from GAMESS, pure HF, MRSF singlet)
# Same as CG test - solver method should not affect results
REF_E1="-275.4900881865"   # MRSF state 1 (target)

# Reference gradient state 1 (from GAMESS)
#          X              Y              Z
REF_C1="-0.031699080   0.097584815  -0.503558245"
REF_C2="-0.029766291  -0.049438048  -0.421751761"
REF_F1=" 0.042021416  -0.273594898   0.425602370"
REF_F2=" 0.057736158   0.235150240   0.346835839"
REF_H1="-0.035943896  -0.069797042   0.077659717"
REF_H2="-0.002348307   0.060094932   0.075212080"
...
# ============ MAIN ============
echo "============================================================"
echo "TEST: ROHF MRSF-TDDFT Gradient with GMRES (C2F2H2, pure HF)"
echo "============================================================"
