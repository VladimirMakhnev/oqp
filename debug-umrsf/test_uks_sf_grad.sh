#!/bin/bash
#
# Test for UKS Spin-Flip TDDFT gradient (BHHLYP functional)
...
# ============ CONFIG ============
INPUT="oqp-uks-sf-grad.inp"
LOG="oqp-uks-sf-grad.log"

# Reference values (from GAMESS, BHHLYP)
REF_E1="-276.6666947340"   # SF state 1 (target)

# Reference gradient state 1 (from GAMESS)
#          X              Y              Z
REF_C1="-0.043282034   0.128876489  -0.481712184"
REF_C2="-0.019176071  -0.085691488  -0.403827192"
REF_F1=" 0.046834696  -0.271092945   0.415592611"
REF_F2=" 0.050530300   0.227748224   0.338549637"
REF_H1="-0.030780730  -0.056373457   0.061589843"
REF_H2="-0.004126161   0.056533177   0.069807285"
...
# ============ MAIN ============
echo "============================================================"
echo "TEST: UKS Spin-Flip TDDFT Gradient (C2F2H2, BHHLYP)"
echo "============================================================"
